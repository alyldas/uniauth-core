...
All repository-facing and GitHub-facing content must be written in English: branch names, commit
messages, PR titles and bodies, issues, labels, milestones, changelog entries, documentation, code
comments, generated artifacts, and release notes. Do not introduce new Russian text into repository
or GitHub artifacts.
